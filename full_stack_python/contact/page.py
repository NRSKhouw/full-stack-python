...
def contact_entry_list_item(contact: model.ContactEntryModel):
    return rx.box(
        rx.heading(contact.first_name), rx.text(contact.message), padding="1em"
    )
...
def contact_entries_list_page() -> rx.Component:
    return base_page(
        rx.vstack(
            ...
            # rx.foreach(["123", "abc"], foreach_callback),
...
def contact_page() -> rx.Component:
    my_child = rx.vstack(
        ...
        rx.desktop_only(rx.box(form.contact_form(), id="my-form-box", width="35vw")),
        rx.mobile_and_tablet(
            rx.box(form.contact_form(), id="my-form-box", width="65vw")
        ),
        spacing="5",
        justify="center",
        align="center",
